...
import { User, Mail, Lock, CheckCircle2, AlertCircle, RefreshCw } from 'lucide-react';
      ...
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2">
        <div className="w-full max-w-[380px] space-y-6">
          <div className="space-y-2 text-center lg:text-left">
            <h1 className="font-display text-3xl font-semibold tracking-tight">Create your CareerMapper account</h1>
            <p className="text-[14px] text-muted-foreground">Build your career profile and discover where your skills can take you.</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-3.5">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="confirmPassword" className="text-[12px] font-semibold">Confirm Password</Label>
              <div className="relative">
                <Lock className="absolute top-2.5 left-3 size-4 text-muted-foreground" />
                <Input
                  id="confirmPassword"
          ...
          <p className="text-[12px] text-center text-muted-foreground leading-normal px-2">
          ...
          <p className="text-center text-[13.5px] text-muted-foreground">
            ...
            <Link to="/signin" className="font-semibold text-foreground underline decoration-1 underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
